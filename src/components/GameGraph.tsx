            ...
            <div className="h-96">
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={displayedData}>
                        ...
                        <Line type="monotone" dataKey="goals" name="Goals" stroke="#eec900" />
                        <Line type="monotone" dataKey="shots" name="Shots" stroke="#ff7300" />
                        <Line type="monotone" dataKey="passes" name="Passes" stroke="#00bfff" />
                        <Line type="monotone" dataKey="carries" name="Carries" stroke="#82ca9d" />
                        <Line type="monotone" dataKey="takeaways" name="Takeaways" stroke="#a83232" />
                    </LineChart>
                </ResponsiveContainer>
            </div>
